...
function flyGame( opts ) {
    ...
    game.rlImg = flyimages["rl"];
    game.jtImg = flyimages["jt"];
    game.lifeImg = flyimages["life"];
    ...
    game.bgScroll = function() {
        ...
        // for(var i=1;i<=game.life;i++){
        //     cxt.drawImage(game.lifeImg.src,380-50*i,0,40,40);
        // }
    ...
    //     var bg_start = flyimages[ "start" ];
    //     cxt.drawImage( bg_start.src, 150, 320, 80,80 );
    // }
    game.start = function() {     // 开始
...
flyGame.prototype.touchclick = function(x,y) {
